...
import { useDealerProductById } from "@/hooks/dealer/useDealerProducts";
import { calculateSavingsPercentage, formatPrice } from "@/lib/utils";
...
const DealerProductDetailsView = ({ productId }: Props) => {
  const { data, isLoading, isError } = useDealerProductById(productId);
...
export default DealerProductDetailsView;
