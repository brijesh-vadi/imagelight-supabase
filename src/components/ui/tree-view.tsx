  ...
  (
    ...
    return (
      <div ref={ref} role="tree" className={className} {...props}>
        <ul>
          {data.map((item) => (
            <li key={item.id} className={level === 0 ? "mb-4" : "my-2"}>
              {item.children ? (
                <TreeNode
                  item={item}
                  level={level ?? 0}
  ...
  return (
    ...
    >
      <AccordionPrimitive.Item value={item.id}>
        ...
        <AccordionContent className="ml-4 pl-2 border-l">
          <TreeItem
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "ml-4 flex text-left items-center py-1.5 cursor-pointer rounded-md",
          treeVariants(),
          className,
          isSelected && selectedTreeVariants(),
          isDragOver && dragOverVariants(),
  ...
  <AccordionPrimitive.Header>
    <AccordionPrimitive.Trigger asChild>
      <div
        ...
        tabIndex={0}
        className={cn(
          "flex flex-1 w-full items-center py-2 cursor-pointer select-none transition-colors",
