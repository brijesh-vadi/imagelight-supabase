...
import ManufacturerCategoryActionsDropdown from "./ManufacturerCategoryActionsDropdown";
import ManufacturerUpdateCategoryModal from "./ManufacturerUpdateCategoryModal";

const ManufacturerCategoriesTable = ({
  categories,
}: {
  categories: Category[];
}) => {
  ...
  return (
    <>
            ...
            <TableRow key={category.id} className="h-14">
              ...
              <TableCell className="pr-5 text-right">
                <div className="flex justify-end gap-2">
                  <ManufacturerCategoryActionsDropdown
      ...
      />
      <ManufacturerUpdateCategoryModal
...
export default ManufacturerCategoriesTable;
